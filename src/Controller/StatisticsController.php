...
class StatisticsController extends AbstractController
{
    ...
    public function list()
    {
		...
		$averageAge = array();
		$averageAge['minAge'] = $minAge;
		$averageAge['maxAge'] = $maxAge;
		$averageAge['averageAge'] = $average;

		//Calculate distribution female/ male:
		$female = 0;
		$male = 0;
		
		foreach ($people as $key => $value)
		{
			if ($value->getGender() == 'Vrouw')
			{
				$female++;
			}
		...
		$genderDistribution[0]['name'] = 'Vrouw';
		$genderDistribution[0]['count'] = $female;
		$genderDistribution[1]['name'] = 'Man';
		$genderDistribution[1]['count'] = $male;
