...
class Funds
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Donation::class, mappedBy="orderId")
     */
    private $donations;
    ...
    public function setFundId(?string $fundId): self
    {
        $this->fundId = $fundId;
